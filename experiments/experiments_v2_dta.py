...
output_dir  =  "/Users/qgf169/Documents/python/Usleep/results/DTA_v2/"
    ...
    for i in range(len(splits)): # across datasplits 
        ...
        for j in range(len(aid)): # across animals 
            if aid[j]!='12':
                ...
                # folder_path="/Users/qgf169/Documents/python/Usleep/results/DTA_v2/"+aid[j] + "/"
