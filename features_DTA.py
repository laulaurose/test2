...
def power_analysis(ss,xEEG,xEMG,tname):
    ...
    for jj in range(49): 
        if len(np.unique(ss.pEEG_EMG==jj))==2:
            ...
            directory = "/Users/qgf169/Documents/python/Usleep/results/DTA/" + tname + "/"
...
elecs       = [["EEG1"],
               ...
               ["EEG1"],
               ["EEG1"]]
groups      = ['Ryan_cleaned_w0', 'Ryan_cleaned_w2', 'Ryan_cleaned_w4', 'Ryan_cleaned_w6']
...
colors = [custom_palette(x) for x in np.linspace(0, 1, 10)]
output_dir = '/Users/qgf169/Documents/python/Usleep/results/DTA/'
...
custom_palette = [cmap(x) for x in np.linspace(0, 4, 10)]
    ...
    for i in range(len(splits)): # across datasplits 
        ...
        for j in range(len(aid)): # across animals 
            if aid[j]!='12':
                ...
                aid_all.append(aid[j])
                group_all_2.append(groups[k])
                state_all.append(np.arange(0,49))
                group_all.append(np.tile(groups[k], 49))
                bin_stage_all +=bin_stage
    print()
    bin_stage_all = bin_stage_all.flatten()
    plt.figure(figsize=(18, 3))  # Adjust the figure size if needed
    sns.barplot(x=np.arange(len(bin_stage_all)), y=bin_stage_all/7 *100,color=custom_palette[k],linewidth=4)
    plt.ylim(0,100)
...
df.to_csv(output_dir+'df_features_DTA_v2.csv', index=False)  # Set index=False to exclude index from the CSV file
print("done")

## dataframe 1
dfn = pd.DataFrame([np.concatenate(f0_all),np.concatenate(state_all),np.concatenate(group_all)])
dfn = dfn.T
dfn.columns = ["RMS_vec","state","group"]
dfn["GT"] = np.where(dfn.group=="Ryan_cleaned_w0","Week0",
                        np.where(dfn.group=="Ryan_cleaned_w2","Week2",
                                np.where(dfn.group=="Ryan_cleaned_w4","Week4",
                                        np.where(dfn.group=="Ryan_cleaned_w6","Week6",np.nan))))

plt.figure(figsize=(30,4))
sns.barplot(x="state",y="RMS_vec",hue="GT",data=dfn,palette=custom_palette,ci=None)
plt.title("RMS")
plt.legend(loc='upper left', bbox_to_anchor=(1, 1), title='Group', shadow=True, ncol=1)
plt.savefig(output_dir+"RMS.png")

dfn = pd.DataFrame([np.concatenate(f1_all),np.concatenate(state_all),np.concatenate(group_all)])
dfn = dfn.T
...
plt.figure(figsize=(30,4))
sns.barplot(x="state",y="avr_bout_length",hue="GT",data=dfn,palette=custom_palette,ci=None)
plt.title("avr_bout_length")
plt.legend(loc='upper left', bbox_to_anchor=(1, 1), title='Group', shadow=True, ncol=1)
plt.savefig(output_dir+"avr_bout_length.png")


dfn = pd.DataFrame([np.concatenate(f2_all),np.concatenate(state_all),np.concatenate(group_all)])
dfn = dfn.T
...
plt.figure(figsize=(30,4))
sns.barplot(x="state",y="total_time",hue="GT",data=dfn,palette=custom_palette,ci=None)
plt.title("total_time")
plt.legend(loc='upper left', bbox_to_anchor=(1, 1), title='Group', shadow=True, ncol=1)
plt.savefig(output_dir+"total_time.png")

dfn = pd.DataFrame([np.concatenate(f3_all),np.concatenate(state_all),np.concatenate(group_all)])
dfn = dfn.T
...
plt.figure(figsize=(30,4))
sns.barplot(x="state",y="counts_h",hue="GT",data=dfn,palette=custom_palette,ci=None)
plt.title("counts_h")
plt.legend(loc='upper left', bbox_to_anchor=(1, 1), title='Group', shadow=True, ncol=1)
plt.savefig(output_dir+"counts_h.png")


dfn = pd.DataFrame([np.concatenate(f4_all),np.concatenate(state_all),np.concatenate(group_all)])
dfn = dfn.T
...
plt.figure(figsize=(30,4))
sns.barplot(x="state",y="4sec",hue="GT",data=dfn,palette=custom_palette,ci=None)
plt.title("4sec")
plt.legend(loc='upper left', bbox_to_anchor=(1, 1), title='Group', shadow=True, ncol=1)
plt.savefig(output_dir+"4sec.png")


dfn = pd.DataFrame([np.concatenate(f5_all),np.concatenate(state_all),np.concatenate(group_all)])
dfn = dfn.T
...
plt.figure(figsize=(30,4))
sns.barplot(x="state",y="4sec_32sec",hue="GT",data=dfn,palette=custom_palette,ci=None)
plt.title("4sec_32sec")
plt.legend(loc='upper left', bbox_to_anchor=(1, 1), title='Group', shadow=True, ncol=1)
plt.savefig(output_dir+"4sec_32sec.png")

dfn = pd.DataFrame([np.concatenate(f6_all),np.concatenate(state_all),np.concatenate(group_all)])
dfn = dfn.T
...
plt.figure(figsize=(30,4))
sns.barplot(x="state",y="32sec_1min",hue="GT",data=dfn,palette=custom_palette,ci=None)
plt.title("32sec_1min")
plt.legend(loc='upper left', bbox_to_anchor=(1, 1), title='Group', shadow=True, ncol=1)
plt.savefig(output_dir+"32sec_1min.png")


dfn = pd.DataFrame([np.concatenate(f7_all),np.concatenate(state_all),np.concatenate(group_all)])
dfn = dfn.T
...
plt.figure(figsize=(30,4))
sns.barplot(x="state",y="1min_5min",hue="GT",data=dfn,palette=custom_palette,ci=None)
plt.title("1min_5min")
plt.legend(loc='upper left', bbox_to_anchor=(1, 1), title='Group', shadow=True, ncol=1)
plt.savefig(output_dir+"1min_5min.png")


dfn = pd.DataFrame([np.concatenate(f8_all),np.concatenate(state_all),np.concatenate(group_all)])
dfn = dfn.T
...
plt.figure(figsize=(30,4))
sns.barplot(x="state",y=">5min_",hue="GT",data=dfn,palette=custom_palette,ci=None)
plt.title("slowoscillations")
plt.legend(loc='upper left', bbox_to_anchor=(1, 1), title='Group', shadow=True, ncol=1)
plt.savefig(output_dir+">5min_.png")

dfn = pd.DataFrame([np.concatenate(f9_all),np.concatenate(state_all),np.concatenate(group_all)])
dfn = dfn.T
...
plt.figure(figsize=(30,4))
sns.barplot(x="state",y="slowoscillations",hue="GT",data=dfn,palette=custom_palette,ci=None)
plt.title("slowoscillations")
plt.legend(loc='upper left', bbox_to_anchor=(1, 1), title='Group', shadow=True, ncol=1)
plt.savefig(output_dir+"slowoscillations.png")

dfn = pd.DataFrame([np.concatenate(f10_all),np.concatenate(state_all),np.concatenate(group_all)])
dfn = dfn.T
...
plt.figure(figsize=(30,4))
sns.barplot(x="state",y="slowdelta",hue="GT",data=dfn,palette=custom_palette,ci=None)
plt.title("slowdelta")
plt.legend(loc='upper left', bbox_to_anchor=(1, 1), title='Group', shadow=True, ncol=1)
plt.savefig(output_dir+"slowdelta.png")


dfn = pd.DataFrame([np.concatenate(f11_all),np.concatenate(state_all),np.concatenate(group_all)])
dfn = dfn.T
...
plt.figure(figsize=(30,4))
sns.barplot(x="state",y="fastdelta",hue="GT",data=dfn,palette=custom_palette,ci=None)
plt.title("fastdelta")
plt.legend(loc='upper left', bbox_to_anchor=(1, 1), title='Group', shadow=True, ncol=1)
plt.savefig(output_dir+"fastdelta.png")

dfn = pd.DataFrame([np.concatenate(f12_all),np.concatenate(state_all),np.concatenate(group_all)])
dfn = dfn.T
...
plt.figure(figsize=(30,4))
sns.barplot(x="state",y="slowtheta",hue="GT",data=dfn,palette=custom_palette,ci=None)
plt.title("slowtheta")
plt.legend(loc='upper left', bbox_to_anchor=(1, 1), title='Group', shadow=True, ncol=1)
plt.savefig(output_dir+"slowtheta.png")

dfn = pd.DataFrame([np.concatenate(f13_all),np.concatenate(state_all),np.concatenate(group_all)])
dfn = dfn.T
...
plt.figure(figsize=(30,4))
sns.barplot(x="state",y="fasttheta",hue="GT",data=dfn,palette=custom_palette,ci=None)
plt.title("fasttheta")
plt.legend(loc='upper left', bbox_to_anchor=(1, 1), title='Group', shadow=True, ncol=1)
plt.savefig(output_dir+"fasttheta.png")

dfn = pd.DataFrame([np.concatenate(f14_all),np.concatenate(state_all),np.concatenate(group_all)])
dfn = dfn.T
...
plt.figure(figsize=(30,4))
sns.barplot(x="state",y="alpha",hue="GT",data=dfn,palette=custom_palette,ci=None)
plt.title("alpha")
plt.legend(loc='upper left', bbox_to_anchor=(1, 1), title='Group', shadow=True, ncol=1)
plt.savefig(output_dir+"alpha.png")


dfn = pd.DataFrame([np.concatenate(f15_all),np.concatenate(state_all),np.concatenate(group_all)])
dfn = dfn.T
...
plt.figure(figsize=(30,4))
sns.barplot(x="state",y="beta",hue="GT",data=dfn,palette=custom_palette,ci=None)
plt.title("beta")
plt.legend(loc='upper left', bbox_to_anchor=(1, 1), title='Group', shadow=True, ncol=1)
plt.savefig(output_dir+"beta.png")


dfn = pd.DataFrame([np.concatenate(f16_all),np.concatenate(state_all),np.concatenate(group_all)])
dfn = dfn.T
...
plt.figure(figsize=(30,4))
sns.barplot(x="state",y="gamma",hue="GT",data=dfn,palette=custom_palette,ci=None)
plt.title("gamma")
plt.legend(loc='upper left', bbox_to_anchor=(1, 1), title='Group', shadow=True, ncol=1)
